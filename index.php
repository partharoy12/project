...
<title>News updating system, Access page</title>
...
<div id="school_header">
  <div id="site_title"> <a href="#"><img src="images/3.png" /><b style="font-size: 25px">DATA EXTRACTION AND UP GRADATION SYSTEM</b> </a> </div>
  <!-- end of site_title -->
  <div id="header_right"> <img src="images/5.png" width="200" height="150" /> </div>
...
<div id="school_main"> <span class="tm_bottom"></span>
  <div id="school_content">
    ...
    <div class="post_box">
      <div class="header">
        <h1><marquee height="30" behavior="slide" direction="up" scrollamount="1"  align="middle"><a href"#">WELCOME TO ADMIN LOGIN PANEL<br/>LOGIN TO MONITOR RECENT NEWS AND UPDATES</a></marquee></h1>
      </div>
      <div id="login">
        <form  method="post" name="form" onsubmit="return validateForm()">
          <table height="196" id='mytable'>
            <tr>
              <td rowspan="5" align="center" style="padding-top:12px;padding-left:12px; border:none;"><img src="images/6.png"   /></td>
            </tr>
            <tr>
...
if (b==null || b=="")
  ...
  return false;
    ...
    <!-- if closes here -->
  </div><img src="images/4.png" width="260" height="250" style="margin:30px; border-radius:5px; border:3px double #FF9966;">
  <div class="cleaner"></div>
</div>
<!-- end of main -->
