    ...
    <div id="school_menubar">
    	<div id="top_nav" class="ddsmoothmenu">
				<ul>
						...
						<li><a href="#">Update</a>
								<ul>
										<li><a href='?action=update_news'> register update_news</a></li>
						...
						<li><a href="#">View records</a>
								<ul>
										...
										<li><a href='?action=recordupdate_news'>update_newss </a></li>
										<li><a href='?action=tattend'>update_newss' attendance</a></li>
    	...
    	<div id="sidebar" class="float_r"> 
        	<div class="sidebar_box"><span class="bottom"></span>
                ...
                <div class="content"> 
                 ...
                 <?php 
				$update_news=mysql_query("select * from update_news");
				$gets=mysql_fetch_array($update_news);
				$counts=mysql_num_rows($update_news);
				$num=1;
				echo '<font color=red> '.$num. '</font>&raquo;  ' .$gets['NAMES'].'<br/>';
				$num=2;

				while($gets=mysql_fetch_array($update_news)){
